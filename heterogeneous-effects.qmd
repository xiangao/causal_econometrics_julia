...
Quintile 5 should have a larger ATE than quintile 1 in this simulation.
One caveat: the quintiles are formed from the same pseudo-outcomes used to
estimate the group ATEs, which biases the spread outward (the top bin
collects positive noise, the bottom bin negative noise). For inference,
form the groups and estimate the ATEs on separate folds.
