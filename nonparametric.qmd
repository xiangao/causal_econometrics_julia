...
println("True ATE = ", round(True_Psi, digits=2))
```
...
println("ATE (plug-in) = ", round(plug_in_ate, digits=2))
```
...
println("ATE (AIPW)   = ", round(aipw_manual, digits=2))
println("95% CI       = [", round(ci_lb, digits=2), ", ", round(ci_ub, digits=2), "]")
```
...
println("\nTrue ATE: ", round(True_Psi, digits=2))
```
...
println("DML PLR Estimate = ", round(theta_hat, digits=2), " (SE = ", round(se_theta, digits=2), ")")
println("95% CI           = [", round(ci_lb, digits=2), ", ", round(ci_ub, digits=2), "]")
```
