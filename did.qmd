...
println("Diff-in-Diff           = ", round(tau_did.estimate, digits=2))
println("Synthetic Control      = ", round(tau_sc.estimate, digits=2))
println("Synthetic Diff-in-Diff = ", round(tau_hat.estimate, digits=2))
```
