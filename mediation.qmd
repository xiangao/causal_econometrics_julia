...
println("CDE(0) G-computation = ", round(cde_gcomp, digits=2))
```
...
println("CDE(0) IPW = ", round(cde_ipw, digits=2))
```
...
println("CDE(0) AIPW = ", round(cde_aipw, digits=2))
```
...
println("NDE = ", round(E_Y1M0 - E_Y0M0, digits=2))
println("NIE = ", round(E_Y1M1 - E_Y1M0, digits=2))
println("ATE = ", round(E_Y1M1 - E_Y0M0, digits=2))
```
...
println("IDE (Direct)   = ", round(ide["estimate"], digits=2), " (SE = ", round(ide["std.error"], digits=2), ")")
println("IIE (Indirect) = ", round(iie["estimate"], digits=2), " (SE = ", round(iie["std.error"], digits=2), ")")
println("ATE            = ", round(result.estimates["ate"]["estimate"], digits=2))
```