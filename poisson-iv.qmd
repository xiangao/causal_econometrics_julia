...
| **C** | Any model | Fitted values $\hat{p}_2$ | Exogeneity of $\mathbf{z}$ only | Moment form matches the error: additive moments need an additive error; multiplicative (Mullahy) moments handle inside-$\exp$ unobservables |
