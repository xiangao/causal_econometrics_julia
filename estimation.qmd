...
&= E_X\{E[Y|W=1, X] - \mu_0(X) \mid W=1\}  \\
& = E_X\{E[Y|W=1, X] \mid W=1\} - (\alpha_0 + E(X \mid W=1) \beta_0)
\end{aligned}
$$ {#eq-estimation-6}
...
$$ {#eq-estimation-9}
 ...
 $$
\begin{aligned}
\hat \tau_{ATT, IPW} &= \bar Y_1 - \frac{1}{N_1} \sum_i \frac{\hat \pi(X_i)(1-W_i) Y_i} {1-\hat \pi(X_i)}
\end{aligned}
$$ {#eq-estimation-10}
...
$$ \mu_0^{AIPW} = E[\frac{(1-W)(Y-\mu_0(X))}{1-\pi(X)} + \mu_0(X)] $$ {#eq-estimation-12}
